...
- korzystne dla prostych logotypów i napisów w kilku kolorach
...
- elementy identyfikacji wizualnej o ograniczonej liczbie kolorów
...
- brak informacji o docelowym położeniu i skali grafiki na plandece
  ...
  "@graph": [
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Czy wykonujecie druk ploterowy wielokolorowy?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Nie. Nie posiadamy plotera drukującego. Wykonujemy malowanie przez szablon."
          }
        },
        {
          "@type": "Question",
          "name": "Ile kolorów można zastosować?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Najlepiej sprawdzają się 1-3 kolory w pełnych kryciach. Więcej kolorów możliwe, ale rośnie koszt i czas."
          }
        },
        {
          "@type": "Question",
          "name": "Jakie pliki akceptujecie do wyceny?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Wektorowe: CDR, AI, PDF z tekstem zamienionym na krzywe. W razie potrzeby dopasujemy skalę do wymiarów plandeki."
          }
        },
        {
          "@type": "Question",
          "name": "Czy farba będzie się łuszczyć?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Przy prawidłowej eksploatacji i czyszczeniu - nie. Farba do PCV łączy się trwale z podłożem."
          }
        },
        {
          "@type": "Question",
          "name": "Czy można dodać oczka nierdzewne?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Tak. Na życzenie dodajemy oczka nierdzewne i ustalamy ich rozstaw."
          }
        },
        {
          "@type": "Question",
          "name": "Czy można odwzorować gradienty i zdjęcia?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Nie. Technika malowania przez szablon obsługuje jednolite pola barw, bez przejść tonalnych."
          }
        }
      ]
    },
    {
      "@type": "Product",
      "name": "Plandeka z grafiką malowaną na wymiar",
      "category": "Tarpaulin",
      "material": "PVC",
      ...
      "offers": {
        ...
        "url": "https://plandeki.com.pl/plandeka-z-grafika-malowana-na-wymiar/"
      }
    }
  ]
}
